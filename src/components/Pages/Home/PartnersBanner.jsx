...
const PartnersBanner = () => {
  return (
    <div className="bg-white py-8 px-6 md:px-12 ">
      ...
      <div className="max-w-5xl mx-auto flex flex-wrap justify-center  items-center gap-2 md:gap-2">
        {/* Restaurant Icon */}
        ...
        {/* Bakery Icon (Duplicate with variation) */}
        <div className="flex flex-col items-center gap-2 text-gray-400">
